        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav">
            <li class="nav-item dropdown show">
              <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" id="themes" aria-expanded="true">Themes <span class="caret"></span></a>
              <div class="dropdown-menu show" aria-labelledby="themes">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" id="download" aria-expanded="false">Yeti <span class="caret"></span></a>
              <div class="dropdown-menu" aria-labelledby="download">
                <a class="dropdown-item" href="https://jsfiddle.net/bootswatch/vdr1vx77/">Open in JSFiddle</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="http://localhost/simona/assets/bootstrap/yeti//bootstrap.min.css">bootstrap.min.css</a>
                <a class="dropdown-item" href="http://localhost/simona/assets/bootstrap/yeti/bootstrap.css">bootstrap.css</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="http://localhost/simona/assets/bootstrap/yeti/_variables.scss">_variables.scss</a>
                <a class="dropdown-item" href="http://localhost/simona/assets/bootstrap/yeti/_bootswatch.scss">_bootswatch.scss</a>
              </div>
            </li>
          </ul>
