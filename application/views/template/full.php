          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="download">
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="<?php echo base_url()?>assets/bootstrap/yeti//bootstrap.min.css">bootstrap.min.css</a>
                <a class="dropdown-item" href="<?php echo base_url()?>assets/bootstrap/yeti/bootstrap.css">bootstrap.css</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="<?php echo base_url()?>assets/bootstrap/yeti/_variables.scss">_variables.scss</a>
                <a class="dropdown-item" href="<?php echo base_url()?>assets/bootstrap/yeti/_bootswatch.scss">_bootswatch.scss</a>
              </div>
            </li>
          </ul>
